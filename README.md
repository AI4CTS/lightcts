...
- **Solar** and **Electricity** datasets from [Google Drive](https://drive.google.com/drive/folders/1hO9jbJMg_JEt1bDhlKjjUIjK41Oqdmv9?usp=sharing) originally provided by [LSTNet](https://arxiv.org/abs/1703.07015). Uncompress them and move them to the data folder.
